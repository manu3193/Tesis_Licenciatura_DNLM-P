...
% Título de la tesis
\newcommand{\scriptTitle}{Implementaci\'on paralela de optimizaciones del filtro Deceived Non-Local Means para la plataforma Xeon Phi} 
...
\begin{document}
  ...
  \include{disclaimer}
  \include{tribunal}  % Remover en versión final
